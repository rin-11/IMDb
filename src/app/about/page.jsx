export default function About() {
    return (
      <div className='max-w-6xl mx-auto p-3 space-y-4'>
        ...
        <p>
          This website is designed to provide you with a comprehensive database of
          movies from all around the world, along with the latest news, reviews,
          and trailers. This movie database is constantly updated with new
        ...
        <p>
          In addition to an extensive movie database, this website also offer a platform
          ...
          ratings from other users. There is also a section dedicated to movie news
          and trailers, keeping you updated with the latest happenings in the
          world of cinema. Thank you for visiting my website and I hope you
